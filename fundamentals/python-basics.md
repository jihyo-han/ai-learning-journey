...
Q14. 기록순으로 정렬하기
다음은 1학년 3반 학생들의 100m 달리기 기록이다. 기록순으로 data를 정렬해보자.(operator.itemgetter를 사용)
